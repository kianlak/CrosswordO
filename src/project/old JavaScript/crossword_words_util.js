...
function findWordToFit(row, column, intersectingRow, crossword, SIDE_LENGTH) {
    let wordLength;
    let letterAtIntersection = crossword[intersectingRow][column];

    console.log(letterAtIntersection)
    ...
    console.log(chosenWord, index, "INDEX", crossword)
